...
/**
 * A container for elements, supporting iteration.
 * Implementing classes need not necessarily be immutable; this interface only guarantees containment.
 *
...
public interface Container<E> extends Iteratable<E, ReadableIterator<E>> {
    ...
    /**
     * Whether all elements of the other container are contained by this container. Does not check the converse.
     *
     * @param other The other container
     * @return {@code true} if all of {@code other}'s elements are contained; {@code false} otherwise
     */
    ...
    /**
     * @return An array containing the same elements as this container, in the same encounter order as
     * {@link #iterator()}
     */
    default E[] toArray() {
