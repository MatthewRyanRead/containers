...
public interface WritableContainer<E> extends Writeratable<E, WritableIterator<E>>, Container<E> {
     ...
     * @return {@code true} if the element was added; {@code false} if the element was already
     *     contained and was not added
     */
    boolean add(@Nullable final E e);

    /**
     * Request to remove an element from the container. Containers that support multiple copies of
     * elements will only remove the first copy encountered.
     *
